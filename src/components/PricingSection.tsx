...
<span className="text-4xl font-bold text-gradient">₹1,999</span>
            ...
            <a
              ...
              className="block w-full text-center bg-gradient-primary text-primary-foreground font-bold py-3.5 rounded-full hover:opacity-90 transition-opacity">Join APEs —  5 Years
...
<span className="text-4xl font-bold">₹1,499</span>
            ...
            <a
              ...
              className="block w-full text-center border-2 border-primary text-primary font-bold py-3.5 rounded-full hover:bg-primary/10 transition-colors">Join APEs —  Lifetime
